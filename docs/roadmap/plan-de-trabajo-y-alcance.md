...
- `[~]` Prueba de flujo completo con datos representativos. La colección Postman ejecutable y la prueba real opt-in Auth → JWT → API están preparadas; falta correrlas con cuentas y datos de prueba del equipo.
